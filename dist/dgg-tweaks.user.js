...
var UTIL = (() => {
    ...
    function getChatLinesElement() {
        return document.querySelector('#chat-win-main .chat-lines') || document.querySelector('.chat-lines');
    }

    return { waitForCSS, injectStylesheet, getChatLinesElement };
})();
